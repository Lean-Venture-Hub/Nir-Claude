# Advanced Ad Analysis Prompt (v2e) - Concise Output Format
...
## CRITICAL: Output Conciseness Rules

**MAXIMUM LENGTH CONSTRAINTS:**

1. **ALL JSON fields**: Maximum 1 sentence (15-25 words ideal)
2. **EXCEPTION - `strategic_analysis_notes`**: Maximum 2 sentences per field

**These rules apply to:**
- `CTA_title`, `CTA_area`, `uvp_usp`, `target_audience`, `image_description`, `Image_text`
- `style.style_description`, `style.brand_alignment`
- `whats_working.*` (all 4 subfields)
- `what_needs_improvement.*` (all 3 subfields)
- `Elements.colors.*` (all 4 subfields)
- `Elements.main_headline.text`
- `Elements.Company_Specific[].reason`
- `Compositional_elements` (comma-separated list, but still brief)

**Exception fields (2 sentences max):**
- `strategic_analysis_notes.creative_angle_rationale`
- `strategic_analysis_notes.contrarian_approach`
- `strategic_analysis_notes.emotional_architecture`
- `strategic_analysis_notes.hook_analysis`
- `strategic_analysis_notes.framework_execution`
- `strategic_analysis_notes.archetype_fit`
- `strategic_analysis_notes.style_strategy`
...
```json
{
      ...
      "Company_Specific": [
         {
            ...
            "asset_type": "Logo | Product screenshot | Brand color | etc",
            "reason": "Max 1 sentence - why it's company-specific"
         }
      ]
   },
   ...
   "strategic_analysis_notes": {
      ...
      "contrarian_approach": "Max 2 sentences - how ad challenges norms (if applicable)",
...
6. **CONCISENESS**: Respect the 1-sentence limit (2 sentences for strategic notes only)
...
### Writing Standards - UPDATED FOR CONCISENESS

- **Maximum 1 sentence per field** (except strategic_analysis_notes)
- **Strategic notes: Maximum 2 sentences** per field
- **Be precise**: Every word must add value
- **Avoid fluff**: No "highly effective" without proof, no obvious statements
- **Use ad language**: Quote specific copy when needed
- **Dense insights**: Pack maximum insight into minimum words

### Strategic Analysis Notes

This section is critical for context and learning. For each note (MAX 2 SENTENCES):
...
- [ ] **ALL fields are 1 sentence max (except strategic_analysis_notes)**
- [ ] **Strategic_analysis_notes fields are 2 sentences max**
...
- [ ] No fluff, no unnecessary words - every sentence is dense with insight
...
**Ambiguous archetype**: Choose closest fit, explain gap in strategic notes (2 sentences max)

**Multiple competing emotions**: Select 2-3 primary emotions, note tension in emotional architecture (2 sentences max)

**No clear hook shape**: Tag as "None/Generic" and suggest stronger alternative in improvement section (1 sentence)
...
**Be precise. Be thorough. Be strategic. BE CONCISE.**

**STRICT RULE: 1 sentence per field, 2 sentences max for strategic_analysis_notes only.**
