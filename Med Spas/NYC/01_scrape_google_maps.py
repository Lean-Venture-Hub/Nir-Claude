#!/usr/bin/env python3
"""
Step 1: Google Maps Scraper for NYC Metro Med Spas
Scrapes Google Maps for med spas using Playwright.

Usage:
  python3 01_scrape_google_maps.py                      # Full run (all boroughs)
  python3 01_scrape_google_maps.py --test                # First search only, 5 results
  python3 01_scrape_google_maps.py --borough=manhattan   # Single borough
...
# Organized by borough — NYC geography from dentist scraper, med spa search terms
SEARCHES = {
    "manhattan": [
        "med spa Midtown Manhattan New York",
        "med spa Upper East Side Manhattan New York",
        "med spa Upper West Side Manhattan New York",
        "med spa Lower Manhattan Financial District New York",
        "med spa East Village Lower East Side Manhattan",
        "med spa Harlem Washington Heights Manhattan",
        "medical spa Chelsea Flatiron Gramercy Manhattan",
        "medspa Murray Hill Kips Bay Manhattan",
        "med spa SoHo Tribeca Greenwich Village Manhattan",
        "botox Midtown Manhattan New York",
        "botox Upper East Side Manhattan New York",
        "aesthetics Manhattan New York",
        "laser hair removal Manhattan New York",
        "coolsculpting Manhattan New York",
        "medical spa Manhattan New York",
    ],
    "brooklyn": [
        "med spa Downtown Brooklyn",
        "med spa Williamsburg Greenpoint Brooklyn",
        "med spa Park Slope Cobble Hill Brooklyn",
        "med spa Bay Ridge Bensonhurst Brooklyn",
        "med spa Flatbush Crown Heights Brooklyn",
        "med spa Bushwick Bed-Stuy Brooklyn",
        "med spa Borough Park Sunset Park Brooklyn",
        "med spa Sheepshead Bay Brighton Beach Brooklyn",
        "med spa Brownsville East New York Brooklyn",
        "medical spa Brooklyn New York",
        "botox Brooklyn New York",
        "aesthetics Brooklyn New York",
        "laser hair removal Brooklyn New York",
    ],
    "queens": [
        "med spa Astoria Long Island City Queens",
        "med spa Flushing Queens New York",
        "med spa Jamaica Queens New York",
        "med spa Forest Hills Rego Park Queens",
        "med spa Bayside Whitestone Queens",
        "med spa Jackson Heights Elmhurst Queens",
        "med spa Ozone Park Richmond Hill Queens",
        "med spa Far Rockaway Rockaway Queens",
        "medical spa Queens New York",
        "botox Queens New York",
        "aesthetics Queens New York",
    ],
    "bronx": [
        "med spa Fordham Bronx New York",
        "med spa Riverdale Kingsbridge Bronx",
        "med spa South Bronx Mott Haven",
        "med spa Pelham Bay Throggs Neck Bronx",
        "med spa Parkchester Castle Hill Bronx",
        "medical spa Bronx New York",
        "botox Bronx New York",
    ],
    "staten_island": [
        "med spa Staten Island New York",
        "medical spa Staten Island New York",
        "botox Staten Island New York",
    ],
    "generic": [
        "med spa New York City",
        "medical spa NYC",
        "medspa New York",
        "botox NYC",
        "coolsculpting NYC",
        "aesthetics clinic New York City",
...
# Borough detection from address — same patterns as dentist scraper
BOROUGH_PATTERNS = {
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"NYC Metro Med Spas — Google Maps Scraper")
