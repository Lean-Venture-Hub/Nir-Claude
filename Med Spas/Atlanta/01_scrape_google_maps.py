#!/usr/bin/env python3
"""
Step 1: Google Maps Scraper for Atlanta Metro Med Spas
...
Usage:
  ...
  python3 01_scrape_google_maps.py --area=core         # Single area
...
SEARCHES = {
    "core": [
        "med spa Downtown Atlanta GA",
        "med spa Midtown Atlanta GA",
        "med spa Buckhead Atlanta GA",
        "medical spa Buckhead Atlanta GA",
        "med spa Virginia Highland Atlanta GA",
        "med spa Inman Park Atlanta GA",
        "med spa West End Atlanta GA",
        "med spa Grant Park Atlanta GA",
        "med spa Old Fourth Ward Atlanta GA",
        "med spa Poncey Highland Atlanta GA",
        "med spa East Atlanta GA",
        "botox Atlanta GA",
        "medical spa Atlanta GA",
        "aesthetics clinic Atlanta GA",
        "laser hair removal Atlanta GA",
        "coolsculpting Atlanta GA",
        "medspa Atlanta GA",
    ],
    "north_fulton": [
        "med spa Sandy Springs GA",
        "med spa Roswell GA",
        "med spa Alpharetta GA",
        "medical spa Alpharetta GA",
        "med spa Johns Creek GA",
        "med spa Milton GA",
        "med spa Dunwoody GA",
        "med spa Brookhaven GA",
        "botox Sandy Springs GA",
        "medspa Roswell GA",
        "aesthetics Dunwoody GA",
    ...
    "cobb": [
        ...
        "med spa Smyrna GA",
        "med spa Kennesaw GA",
        "medical spa Marietta GA",
        "med spa Acworth GA",
        "med spa Powder Springs GA",
        "med spa Austell GA",
        "med spa Mableton GA",
        "botox Marietta GA",
        "medspa Smyrna GA",
    ...
    "gwinnett": [
        "med spa Lawrenceville GA",
        "med spa Duluth GA",
        "med spa Suwanee GA",
        "med spa Norcross GA",
        "medical spa Duluth GA",
        "med spa Lilburn GA",
        "med spa Snellville GA",
        "med spa Buford GA",
        "med spa Dacula GA",
        "med spa Loganville GA",
        "botox Duluth GA",
        "medspa Lawrenceville GA",
    ],
    "dekalb": [
        "med spa Decatur GA",
        "med spa Tucker GA",
        "med spa Stone Mountain GA",
        "medical spa Decatur GA",
        "med spa Lithonia GA",
        "med spa Chamblee GA",
        "med spa Doraville GA",
        "botox Decatur GA",
    ],
    "south": [
        "med spa College Park GA",
        "med spa East Point GA",
        "med spa Jonesboro GA",
        "med spa Morrow GA",
        "med spa Riverdale GA",
        "med spa Forest Park GA",
        "med spa Union City GA",
        "med spa Fairburn GA",
        "botox Jonesboro GA",
    ],
    "henry_fayette": [
        "med spa McDonough GA",
        "med spa Stockbridge GA",
        "med spa Fayetteville GA",
        "med spa Peachtree City GA",
        "medical spa Peachtree City GA",
        "med spa Hampton GA",
        "med spa Locust Grove GA",
        "botox Peachtree City GA",
    ],
    "cherokee_forsyth": [
        "med spa Woodstock GA",
        "med spa Canton GA",
        "med spa Holly Springs GA",
        "med spa Cumming GA",
    ...
    "west_outer": [
        "med spa Douglasville GA",
        "med spa Villa Rica GA",
        "med spa Hiram GA",
        "med spa Dallas GA",
        "med spa Cartersville GA",
        "botox Douglasville GA",
    ],
    "east_outer": [
        "med spa Conyers GA",
        "med spa Covington GA",
        "med spa Monroe GA",
        "botox Conyers GA",
    ],
}
...
AREA_ORDER = [
    "core", "north_fulton", "cobb", "gwinnett", "dekalb",
    "south", "henry_fayette", "cherokee_forsyth", "west_outer", "east_outer",
]

# Area detection from address — same geography as dentist scraper
AREA_PATTERNS = {
    "Core Atlanta": ["atlanta, ga 303"],
    "North Fulton": ["sandy springs", "roswell", "alpharetta", "johns creek",
                     "milton", "dunwoody", "brookhaven"],
    "Cobb": ["marietta", "smyrna", "kennesaw", "acworth", "powder springs",
             "austell", "mableton"],
    "Gwinnett": ["lawrenceville", "duluth", "suwanee", "norcross", "lilburn",
                 "snellville", "buford", "dacula", "grayson", "loganville"],
    "DeKalb": ["decatur", "tucker", "stone mountain", "lithonia", "chamblee",
               "doraville", "clarkston"],
    "South": ["college park", "east point", "jonesboro", "morrow", "riverdale",
              "forest park", "union city", "fairburn"],
    "Henry/Fayette": ["mcdonough", "stockbridge", "fayetteville", "peachtree city",
                      "hampton", "locust grove", "tyrone"],
    "Cherokee/Forsyth": ["woodstock", "canton", "holly springs", "cumming",
                         "ball ground"],
    "West": ["douglasville", "lithia springs", "villa rica", "hiram", "dallas"],
    "East": ["conyers", "covington", "monroe"],
}
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Atlanta Metro Med Spas — Google Maps Scraper")
