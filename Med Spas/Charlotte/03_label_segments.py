#!/usr/bin/env python3
"""
Step 3: Segment Labeling for Charlotte Med Spas
Reads enriched CSV, applies segmentation logic, outputs labeled-medspas.csv.

Usage:
  python3 03_label_segments.py
"""
...
OUTPUT_CSV = os.path.join(SCRIPT_DIR, "labeled-medspas.csv")


def assign_segment(row):
    """
    Assign segment based on rating, review count, and website presence.
    Same logic as dentist pipeline — works for any local business.
    """
...
def main():
    if not os.path.exists(INPUT_CSV):
        ...
        print("Run 02_enrich_websites.py first.")
        sys.exit(1)
