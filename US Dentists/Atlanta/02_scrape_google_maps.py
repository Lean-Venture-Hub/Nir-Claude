#!/usr/bin/env python3
"""
Step 2: Google Maps Scraper for Atlanta Metro Dentists
...
SEARCHES = {
    "core": [
        "dentist Downtown Atlanta GA",
        "dentist Midtown Atlanta GA",
        "dentist Buckhead Atlanta GA",
        "dentist Virginia Highland Atlanta GA",
        "dentist Inman Park Atlanta GA",
        "dentist West End Atlanta GA",
        "dentist Grant Park Atlanta GA",
        "dentist Old Fourth Ward Atlanta GA",
        "dentist Poncey Highland Atlanta GA",
        "dentist East Atlanta GA",
    ],
    "north_fulton": [
    ...
    "gwinnett": [
        ...
        "dentist Norcross GA",
        "dentist Lilburn GA",
        "dentist Snellville GA",
        "dentist Buford GA",
        "dentist Dacula GA",
        "dentist Loganville GA",
    ],
    "dekalb": [
        "dentist Decatur GA",
        "dentist Tucker GA",
        "dentist Stone Mountain GA",
        "dentist Lithonia GA",
        "dentist Chamblee GA",
        "dentist Doraville GA",
    ],
    "south": [
        "dentist College Park GA",
        "dentist East Point GA",
        "dentist Jonesboro GA",
        "dentist Morrow GA",
        "dentist Riverdale GA",
        "dentist Forest Park GA",
        "dentist Union City GA",
        "dentist Fairburn GA",
    ],
    "henry_fayette": [
        "dentist McDonough GA",
        "dentist Stockbridge GA",
        "dentist Fayetteville GA",
        "dentist Peachtree City GA",
        "dentist Hampton GA",
        "dentist Locust Grove GA",
    ],
    "cherokee_forsyth": [
        "dentist Woodstock GA",
        "dentist Canton GA",
        "dentist Holly Springs GA",
        "dentist Cumming GA",
    ],
    "west_outer": [
        "dentist Douglasville GA",
        "dentist Villa Rica GA",
        "dentist Hiram GA",
        "dentist Dallas GA",
    ...
    "generic": [
        ...
        "pediatric dentist Atlanta GA",
    ],
}

AREA_ORDER = [
    "core", "north_fulton", "cobb", "gwinnett", "dekalb",
    "south", "henry_fayette", "cherokee_forsyth", "west_outer", "east_outer", "generic",
]
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Atlanta Metro Dental Clinics — Google Maps Scraper")
