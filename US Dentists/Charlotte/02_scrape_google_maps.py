#!/usr/bin/env python3
"""
Step 2: Google Maps Scraper for Charlotte Metro Dentists
...
SEARCHES = {
    "central": [
        "dentist Uptown Charlotte NC",
        "dentist South End Charlotte NC",
        "dentist NoDa Charlotte NC",
        "dentist Plaza Midwood Charlotte NC",
        "dentist Dilworth Charlotte NC",
        "dentist Myers Park Charlotte NC",
        "dentist Elizabeth Charlotte NC",
        "dentist Downtown Charlotte NC",
    ],
    "south": [
        "dentist Pineville NC",
        "dentist Ballantyne Charlotte NC",
        "dentist Steele Creek Charlotte NC",
        "dentist Fort Mill SC",
        "dentist Indian Land SC",
        "dentist Tega Cay SC",
        "dentist Lake Wylie SC",
        "dentist Rock Hill SC",
    ],
    "north": [
        "dentist Huntersville NC",
        "dentist Cornelius NC",
        "dentist Davidson NC",
        "dentist Mooresville NC",
        "dentist Statesville NC",
        "dentist University City Charlotte NC",
    ],
    "east": [
        "dentist Matthews NC",
        "dentist Mint Hill NC",
        "dentist Indian Trail NC",
        "dentist Monroe NC",
        "dentist Stallings NC",
        "dentist Waxhaw NC",
        "dentist Weddington NC",
        "dentist Harrisburg NC",
        "dentist Concord NC",
        "dentist Kannapolis NC",
    ],
    "west": [
        "dentist Gastonia NC",
        "dentist Belmont NC",
        "dentist Mount Holly NC",
        "dentist Lincolnton NC",
        "dentist Shelby NC",
    ],
    "northwest": [
        "dentist Salisbury NC",
        "dentist China Grove NC",
        "dentist Albemarle NC",
    ],
    "generic": [
        "dental clinic Charlotte NC",
        "emergency dentist Charlotte NC",
        "cosmetic dentist Charlotte NC",
        "pediatric dentist Charlotte NC",
    ],
}

AREA_ORDER = ["central", "south", "north", "east", "west", "northwest", "generic"]
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Charlotte Metro Dental Clinics — Google Maps Scraper")
