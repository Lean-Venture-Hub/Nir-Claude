#!/usr/bin/env python3
"""
Step 1: NPI Registry Scraper for Charlotte Metro Dentists
Queries the free federal NPI API for every licensed dentist in Charlotte metro.
...
# Charlotte metro: Mecklenburg + surrounding NC counties + York/Lancaster SC
QUERIES = [
    # Mecklenburg County (core)
    {"city": "Charlotte", "state": "NC", "label": "Charlotte"},
    {"city": "Huntersville", "state": "NC", "label": "Huntersville"},
    {"city": "Cornelius", "state": "NC", "label": "Cornelius"},
    {"city": "Davidson", "state": "NC", "label": "Davidson"},
    {"city": "Matthews", "state": "NC", "label": "Matthews"},
    {"city": "Mint Hill", "state": "NC", "label": "Mint Hill"},
    {"city": "Pineville", "state": "NC", "label": "Pineville"},
    # Cabarrus County
    {"city": "Concord", "state": "NC", "label": "Concord"},
    {"city": "Kannapolis", "state": "NC", "label": "Kannapolis"},
    {"city": "Harrisburg", "state": "NC", "label": "Harrisburg"},
    # Union County
    {"city": "Monroe", "state": "NC", "label": "Monroe"},
    {"city": "Indian Trail", "state": "NC", "label": "Indian Trail"},
    {"city": "Waxhaw", "state": "NC", "label": "Waxhaw"},
    {"city": "Stallings", "state": "NC", "label": "Stallings"},
    {"city": "Weddington", "state": "NC", "label": "Weddington"},
    {"city": "Wesley Chapel", "state": "NC", "label": "Wesley Chapel"},
    # Gaston County
    {"city": "Gastonia", "state": "NC", "label": "Gastonia"},
    {"city": "Belmont", "state": "NC", "label": "Belmont"},
    {"city": "Mount Holly", "state": "NC", "label": "Mount Holly"},
    {"city": "Dallas", "state": "NC", "label": "Dallas NC"},
    {"city": "Cramerton", "state": "NC", "label": "Cramerton"},
    # Iredell County
    {"city": "Mooresville", "state": "NC", "label": "Mooresville"},
    {"city": "Statesville", "state": "NC", "label": "Statesville"},
    # Lincoln County
    {"city": "Lincolnton", "state": "NC", "label": "Lincolnton"},
    {"city": "Denver", "state": "NC", "label": "Denver NC"},
    # Rowan County
    {"city": "Salisbury", "state": "NC", "label": "Salisbury"},
    {"city": "China Grove", "state": "NC", "label": "China Grove"},
    # Stanly County
    {"city": "Albemarle", "state": "NC", "label": "Albemarle"},
    # Cleveland County
    {"city": "Shelby", "state": "NC", "label": "Shelby"},
    # York County SC (south of border)
    {"city": "Fort Mill", "state": "SC", "label": "Fort Mill SC"},
    {"city": "Rock Hill", "state": "SC", "label": "Rock Hill SC"},
    {"city": "Tega Cay", "state": "SC", "label": "Tega Cay SC"},
    {"city": "Lake Wylie", "state": "SC", "label": "Lake Wylie SC"},
    {"city": "Clover", "state": "SC", "label": "Clover SC"},
    {"city": "York", "state": "SC", "label": "York SC"},
    # Lancaster County SC
    {"city": "Lancaster", "state": "SC", "label": "Lancaster SC"},
    {"city": "Indian Land", "state": "SC", "label": "Indian Land SC"},
]
...
def main():
    ...
    print("=" * 60)
    print("NPI Registry Scraper — Charlotte Metro Dentists")
