#!/usr/bin/env python3
"""
Step 2: Google Maps Scraper for Denver Metro Dentists
...
Usage:
  ...
  python3 02_scrape_google_maps.py --area=central      # Single area
...
SEARCHES = {
    "central": [
        "dentist Downtown Denver CO",
        "dentist Capitol Hill Denver CO",
        "dentist Cherry Creek Denver CO",
        "dentist Highlands Denver CO",
        "dentist LoDo Denver CO",
        "dentist Park Hill Denver CO",
        "dentist Washington Park Denver CO",
        "dentist RiNo Denver CO",
        "dentist Stapleton Denver CO",
    ],
    "south": [
        "dentist Littleton CO",
        "dentist Englewood CO",
        "dentist Centennial CO",
        "dentist Highlands Ranch CO",
        "dentist Lone Tree CO",
        "dentist Parker CO",
    ...
    "west": [
        ...
        "dentist Golden CO",
        "dentist Arvada CO",
        "dentist Wheat Ridge CO",
    ],
    "north": [
        "dentist Westminster CO",
        "dentist Thornton CO",
        "dentist Northglenn CO",
        "dentist Broomfield CO",
        "dentist Brighton CO",
        "dentist Commerce City CO",
    ],
    "aurora": [
        "dentist Aurora CO",
        "dentist Greenwood Village CO",
    ],
    "boulder": [
        "dentist Boulder CO",
        "dentist Louisville CO",
        "dentist Lafayette CO",
        "dentist Longmont CO",
        "dentist Erie CO",
    ],
    "generic": [
        "dental clinic Denver CO",
...
AREA_ORDER = ["central", "south", "west", "north", "aurora", "boulder", "generic"]

# Area detection from address
AREA_PATTERNS = {
    "Central Denver": ["denver, co 802"],
    "South": ["littleton", "englewood", "centennial", "highlands ranch", "lone tree",
              "parker", "castle rock", "castle pines"],
    "West": ["lakewood", "golden", "arvada", "wheat ridge", "edgewater", "morrison"],
    "North": ["westminster", "thornton", "northglenn", "broomfield", "brighton",
              "commerce city", "federal heights"],
    "Aurora": ["aurora", "greenwood village"],
    "Boulder": ["boulder", "louisville", "lafayette", "superior", "longmont", "erie"],
}
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Denver Metro Dental Clinics — Google Maps Scraper")
