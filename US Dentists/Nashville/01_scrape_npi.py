#!/usr/bin/env python3
"""
Step 1: NPI Registry Scraper for Nashville Metro Dentists
Queries the free federal NPI API for every licensed dentist in Nashville metro.
...
# Nashville metro: Davidson County + surrounding counties
QUERIES = [
    # Core Nashville / Davidson County
    {"city": "Nashville", "state": "TN", "label": "Nashville"},
    {"city": "Antioch", "state": "TN", "label": "Antioch"},
    {"city": "Hermitage", "state": "TN", "label": "Hermitage"},
    {"city": "Donelson", "state": "TN", "label": "Donelson"},
    {"city": "Madison", "state": "TN", "label": "Madison"},
    {"city": "Goodlettsville", "state": "TN", "label": "Goodlettsville"},
    {"city": "Old Hickory", "state": "TN", "label": "Old Hickory"},
    # Williamson County
    {"city": "Franklin", "state": "TN", "label": "Franklin"},
    {"city": "Brentwood", "state": "TN", "label": "Brentwood"},
    {"city": "Spring Hill", "state": "TN", "label": "Spring Hill"},
    {"city": "Nolensville", "state": "TN", "label": "Nolensville"},
    {"city": "Thompson's Station", "state": "TN", "label": "Thompson's Station"},
    {"city": "Fairview", "state": "TN", "label": "Fairview"},
    # Rutherford County
    {"city": "Murfreesboro", "state": "TN", "label": "Murfreesboro"},
    {"city": "Smyrna", "state": "TN", "label": "Smyrna"},
    {"city": "La Vergne", "state": "TN", "label": "La Vergne"},
    # Sumner County
    {"city": "Hendersonville", "state": "TN", "label": "Hendersonville"},
    {"city": "Gallatin", "state": "TN", "label": "Gallatin"},
    {"city": "Portland", "state": "TN", "label": "Portland"},
    {"city": "White House", "state": "TN", "label": "White House"},
    {"city": "Millersville", "state": "TN", "label": "Millersville"},
    # Wilson County
    {"city": "Mount Juliet", "state": "TN", "label": "Mount Juliet"},
    {"city": "Lebanon", "state": "TN", "label": "Lebanon"},
    # Other nearby
    {"city": "Dickson", "state": "TN", "label": "Dickson"},
    {"city": "Springfield", "state": "TN", "label": "Springfield"},
    {"city": "Columbia", "state": "TN", "label": "Columbia"},
    {"city": "Clarksville", "state": "TN", "label": "Clarksville"},
    {"city": "Shelbyville", "state": "TN", "label": "Shelbyville"},
]
...
def main():
    ...
    print("=" * 60)
    print("NPI Registry Scraper — Nashville Metro Dentists")
