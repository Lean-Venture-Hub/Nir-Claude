#!/usr/bin/env python3
"""
Step 5: Segment Labeling for Nashville Metro Dentists
Reads enriched CSV, applies segmentation logic, outputs labeled-dentals.csv.
Exact same logic as Israel pipeline (from labeled-outreach-guide.md).
...
def assign_segment(row):
    ...
    Exact logic from labeled-outreach-guide.md.
    """
