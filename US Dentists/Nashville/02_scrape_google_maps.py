#!/usr/bin/env python3
"""
Step 2: Google Maps Scraper for Nashville Metro Dentists
...
SEARCHES = {
    "core": [
        "dentist Downtown Nashville TN",
        "dentist West Nashville TN",
        "dentist East Nashville TN",
        "dentist Midtown Nashville TN",
        "dentist Green Hills Nashville TN",
        "dentist Belle Meade Nashville TN",
        "dentist Bellevue Nashville TN",
        "dentist Germantown Nashville TN",
    ],
    "south_davidson": [
        "dentist Antioch Nashville TN",
        "dentist Hermitage Nashville TN",
        "dentist Donelson Nashville TN",
    ],
    "north": [
        "dentist Madison Nashville TN",
        "dentist Goodlettsville TN",
        "dentist Hendersonville TN",
        "dentist Gallatin TN",
        "dentist White House TN",
        "dentist Portland TN",
    ],
    "williamson": [
        "dentist Franklin TN",
        "dentist Brentwood TN",
        "dentist Spring Hill TN",
        "dentist Nolensville TN",
        "dentist Thompson Station TN",
        "dentist Fairview TN",
    ],
    "rutherford": [
        "dentist Murfreesboro TN",
        "dentist Smyrna TN",
        "dentist La Vergne TN",
    ],
    "wilson": [
        "dentist Mount Juliet TN",
        "dentist Lebanon TN",
    ],
    "outer": [
        "dentist Clarksville TN",
        "dentist Dickson TN",
        "dentist Springfield TN",
        "dentist Columbia TN",
    ],
    "generic": [
        "dental clinic Nashville TN",
        "emergency dentist Nashville TN",
        "cosmetic dentist Nashville TN",
        "pediatric dentist Nashville TN",
    ],
}

AREA_ORDER = ["core", "south_davidson", "north", "williamson", "rutherford", "wilson", "outer", "generic"]

# Area detection from address
AREA_PATTERNS = {
    "Core Nashville": ["nashville, tn 372"],
    "South Davidson": ["antioch", "hermitage", "donelson"],
    "North": ["madison", "goodlettsville", "hendersonville", "gallatin", "white house", "portland", "millersville"],
    "Williamson": ["franklin", "brentwood", "spring hill", "nolensville", "thompson"],
    "Rutherford": ["murfreesboro", "smyrna", "la vergne"],
    "Wilson": ["mount juliet", "mt juliet", "lebanon"],
    "Outer": ["clarksville", "dickson", "springfield", "columbia"],
}
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Nashville Metro Dental Clinics — Google Maps Scraper")
