#!/usr/bin/env python3
"""
Step 1: NPI Registry Scraper for Phoenix Metro Dentists
Queries the free federal NPI API for every licensed dentist in Phoenix metro.
...
QUERIES = [
    ...
    # East Valley
    {"city": "Mesa", "state": "AZ", "label": "Mesa"},
    {"city": "Chandler", "state": "AZ", "label": "Chandler"},
    {"city": "Gilbert", "state": "AZ", "label": "Gilbert"},
    {"city": "Tempe", "state": "AZ", "label": "Tempe"},
    {"city": "Queen Creek", "state": "AZ", "label": "Queen Creek"},
    {"city": "Apache Junction", "state": "AZ", "label": "Apache Junction"},
    {"city": "San Tan Valley", "state": "AZ", "label": "San Tan Valley"},
    # North / Scottsdale
    {"city": "Scottsdale", "state": "AZ", "label": "Scottsdale"},
    {"city": "Cave Creek", "state": "AZ", "label": "Cave Creek"},
    {"city": "Carefree", "state": "AZ", "label": "Carefree"},
    {"city": "Fountain Hills", "state": "AZ", "label": "Fountain Hills"},
    {"city": "Paradise Valley", "state": "AZ", "label": "Paradise Valley"},
    # West Valley
    {"city": "Glendale", "state": "AZ", "label": "Glendale"},
    {"city": "Peoria", "state": "AZ", "label": "Peoria"},
    {"city": "Surprise", "state": "AZ", "label": "Surprise"},
    {"city": "Avondale", "state": "AZ", "label": "Avondale"},
    {"city": "Goodyear", "state": "AZ", "label": "Goodyear"},
    {"city": "Buckeye", "state": "AZ", "label": "Buckeye"},
    {"city": "Litchfield Park", "state": "AZ", "label": "Litchfield Park"},
    {"city": "El Mirage", "state": "AZ", "label": "El Mirage"},
    {"city": "Tolleson", "state": "AZ", "label": "Tolleson"},
    {"city": "Sun City", "state": "AZ", "label": "Sun City"},
    {"city": "Sun City West", "state": "AZ", "label": "Sun City West"},
    # Pinal County
    {"city": "Casa Grande", "state": "AZ", "label": "Casa Grande"},
    {"city": "Maricopa", "state": "AZ", "label": "Maricopa"},
    {"city": "Florence", "state": "AZ", "label": "Florence"},
    {"city": "Coolidge", "state": "AZ", "label": "Coolidge"},
]
...
def main():
    ...
    print("=" * 60)
    print("NPI Registry Scraper — Phoenix Metro Dentists")
