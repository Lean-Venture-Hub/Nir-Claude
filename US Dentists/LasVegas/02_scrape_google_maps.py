#!/usr/bin/env python3
"""
Step 2: Google Maps Scraper for Las Vegas Metro Dentists
...
SEARCHES = {
    "central": [
        "dentist Downtown Las Vegas NV",
        "dentist Summerlin Las Vegas NV",
        "dentist Spring Valley Las Vegas NV",
        "dentist Centennial Hills Las Vegas NV",
        "dentist Southwest Las Vegas NV",
        "dentist Northwest Las Vegas NV",
        "dentist East Las Vegas NV",
    ],
    "henderson": [
        "dentist Henderson NV",
        "dentist Green Valley Henderson NV",
        "dentist Anthem Henderson NV",
        "dentist Lake Las Vegas Henderson NV",
    ],
    "north_lv": [
        "dentist North Las Vegas NV",
        "dentist Aliante North Las Vegas NV",
    ],
    "enterprise": [
        "dentist Enterprise Las Vegas NV",
        "dentist Southern Highlands Las Vegas NV",
        "dentist Mountains Edge Las Vegas NV",
    ],
    "outer": [
        "dentist Boulder City NV",
        "dentist Mesquite NV",
        "dentist Pahrump NV",
    ],
    "generic": [
        "dental clinic Las Vegas NV",
...
AREA_ORDER = ["central", "henderson", "north_lv", "enterprise", "outer", "generic"]

# Area detection from address
AREA_PATTERNS = {
    "Central Las Vegas": ["las vegas, nv 891"],
    "Henderson": ["henderson"],
    "North Las Vegas": ["north las vegas", "n las vegas"],
    "Summerlin": ["summerlin"],
    "Enterprise": ["enterprise", "southern highlands", "mountains edge"],
    "Outer": ["boulder city", "mesquite", "pahrump", "laughlin"],
}
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Las Vegas Metro Dental Clinics — Google Maps Scraper")
