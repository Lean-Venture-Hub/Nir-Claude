#!/usr/bin/env python3
"""
Step 1: NPI Registry Scraper for Las Vegas Metro Dentists
Queries the free federal NPI API for every licensed dentist in Las Vegas metro.
...
# Las Vegas metro: Clark County + surrounding areas
QUERIES = [
    # Core Las Vegas
    {"city": "Las Vegas", "state": "NV", "label": "Las Vegas"},
    # Henderson
    {"city": "Henderson", "state": "NV", "label": "Henderson"},
    # North Las Vegas
    {"city": "North Las Vegas", "state": "NV", "label": "North Las Vegas"},
    # Suburbs (use Las Vegas for NPI — Summerlin, Spring Valley, Enterprise, Paradise are within Las Vegas)
    # These are CDPs within Las Vegas city limits, so NPI uses "Las Vegas"
    # Outer areas
    {"city": "Boulder City", "state": "NV", "label": "Boulder City"},
    {"city": "Mesquite", "state": "NV", "label": "Mesquite"},
    {"city": "Pahrump", "state": "NV", "label": "Pahrump"},
    {"city": "Laughlin", "state": "NV", "label": "Laughlin"},
]
...
def main():
    ...
    print("=" * 60)
    print("NPI Registry Scraper — Las Vegas Metro Dentists")
