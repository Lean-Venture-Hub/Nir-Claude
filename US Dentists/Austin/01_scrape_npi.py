#!/usr/bin/env python3
"""
Step 1: NPI Registry Scraper for Austin Metro Dentists
Queries the free federal NPI API for every licensed dentist in Austin metro.
...
# Austin metro: Travis, Williamson, Hays, Bastrop, Caldwell counties
QUERIES = [
    # Core Austin
    {"city": "Austin", "state": "TX", "label": "Austin"},
    # North — Williamson County
    {"city": "Round Rock", "state": "TX", "label": "Round Rock"},
    {"city": "Cedar Park", "state": "TX", "label": "Cedar Park"},
    {"city": "Leander", "state": "TX", "label": "Leander"},
    {"city": "Georgetown", "state": "TX", "label": "Georgetown"},
    {"city": "Pflugerville", "state": "TX", "label": "Pflugerville"},
    {"city": "Hutto", "state": "TX", "label": "Hutto"},
    # South — Hays / Caldwell County
    {"city": "San Marcos", "state": "TX", "label": "San Marcos"},
    {"city": "Kyle", "state": "TX", "label": "Kyle"},
    {"city": "Buda", "state": "TX", "label": "Buda"},
    {"city": "Dripping Springs", "state": "TX", "label": "Dripping Springs"},
    {"city": "Wimberley", "state": "TX", "label": "Wimberley"},
    # East — Bastrop County
    {"city": "Manor", "state": "TX", "label": "Manor"},
    {"city": "Elgin", "state": "TX", "label": "Elgin"},
    {"city": "Bastrop", "state": "TX", "label": "Bastrop"},
    {"city": "Taylor", "state": "TX", "label": "Taylor"},
    # West — Travis County west
    {"city": "Lakeway", "state": "TX", "label": "Lakeway"},
    {"city": "Bee Cave", "state": "TX", "label": "Bee Cave"},
    {"city": "Lago Vista", "state": "TX", "label": "Lago Vista"},
    {"city": "West Lake Hills", "state": "TX", "label": "West Lake Hills"},
    {"city": "Rollingwood", "state": "TX", "label": "Rollingwood"},
]
...
def main():
    ...
    print("=" * 60)
    print("NPI Registry Scraper — Austin Metro Dentists")
