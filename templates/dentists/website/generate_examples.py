...
DATA = {
    ...
    # Images (relative to template-N/ folder)
    "HERO_IMAGE": "../../images/template-images/image2.png",
    "HERO_IMAGE_ALT": "מרפאת חיוך פלוס — תל אביב",
    "ABOUT_IMAGE": "../../images/template-images/image7.png",
    "ABOUT_IMAGE_ALT": "ד״ר מיכל לוי — מרפאת חיוך פלוס",
    "DOCTOR_IMAGE": "../../images/template-images/image9.png",
...
def generate_examples():
    templates = sorted(glob.glob(os.path.join(TEMPLATE_DIR, "template-*/template-[0-9]*.html")))
